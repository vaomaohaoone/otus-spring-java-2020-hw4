...
9. Работа приложения с spring shell

Сборка: mvn install  
Запуск: java -jar otus-spring-hw3-1.0-SNAPSHOT.jar
Команды:
1. start - запуск тестирования
2. exit - остановка приложения и печать результатов
